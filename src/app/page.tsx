...
export default function Home() {
  return (
    <main className="relative min-h-screen">
      <ScrollToOnLoad />
      <HeroBanner />
      <section className="bg-gradient-to-br from-emerald-100 via-emerald-50/5 to-white">
        <section id="retreat" className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-800 text-lg leading-relaxed mb-4">
              Escape the ordinary and rediscover yourself amidst the serene
              beauty of the Konkan coast. Join us for a transformative 2-day
              beachside healing retreat at the tranquil Chivla Paradise in
              Malvan.
            </p>
            <p className="text-gray-800 leading-relaxed">
              Imagine: the gentle embrace of monsoon rains, the calming rhythm
              of ocean waves, and the rejuvenating power of nature harmonizing
              to uplift your spirit. This isn&apos;t just a getaway; it&apos;s a
              sacred space to reconnect with your innermost self and emerge
              lighter, freer, and full of life.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-3 text-gray-900 leading-relaxed marker:text-emerald-600">
              <li>
                <span className="font-semibold">Mindful Experiences</span>:
                Immerse yourself in the present moment with guided practices
                designed to cultivate inner peace.
              </li>
              <li>
                <span className="font-semibold">
                  Guided Meditations by the Sea
                </span>
                : Let the ocean&apos;s calming energy deepen your meditative
                journey and soothe your soul.
              </li>
              <li>
              ...
              <li>
                ...
                : Engage with the natural elements of Malvan for profound
              ...
              <li>
                ...
                : Nourish your body with wholesome, local flavors and connect
                with like-minded individuals in meaningful dialogue.
              </li>
            </ul>
            ...
            <div className="my-6">
              ...
              <p className="text-gray-800">
                <span className="font-semibold">Batch 2</span>: 12th-14th
                September 2025
              </p>
            </div>
          ...
          <div className="!my-0 relative flex-1 overflow-y-auto">
            <div className="px-4 md:px-6 lg:px-10 pb-8 pt-8 lg:pt-40">
              ...
              <p className="text-center text-base sm:text-lg max-w-4xl mx-auto font-semibold mt-4">
                ...
                our site to find out more about our rooms, food and amenities,
                and get in touch if there&apos;s anything else we can help you
                with. We look forward to welcoming you soon!
              </p>
              <div className="my-8 lg:my-10">
                ...
                <p className="text-center text-base sm:text-lg max-w-4xl mx-auto font-semibold">
                  I am the founder of Chivla Paradise, a serene beachside
                  retreat in Malvan, where I blend hospitality with healing
                  through immersive wellness experiences. I am an
                  internationally certified NLP Trainer and Life Coach dedicated
                  to helping people unlock their fullest potential. With
                  corporate experience, expertise in personal growth, and a
                  passion for dance and movement therapy, I inspire
                  transformation by guiding individuals to reconnect with their
                  authentic selves.
                </p>
              </div>
            ...
            <div>
              ...
              <div className="text-center text-base sm:text-lg max-w-4xl mx-auto font-semibold mb-8">
                Choose between our Sea View Room, offering breathtaking vistas
                of the ocean, and our Standard Room, a cozy retreat with all the
            ...
            <div className="mt-8">
              ...
              <p className="text-center text-base sm:text-lg max-w-4xl mx-auto font-semibold mb-8">
                The food we serve at Chivla Paradise is authentic Malvani
                cuisine and has been carefully crafted. We only use fresh fish
                and ingredients, and are happy to cater to different dietary
                requirements.
              </p>
      ...
      <section className="bg-gradient-to-br from-white to-orange-100 ">
        <section className="relative" id="gallery">
          <div className="layout overflow-hidden">
            ...
            <p className="text-center text-sm sm:text-base md:text-lg max-w-4xl mx-auto font-semibold my-6 sm:my-8 md:my-10 px-4">
              ...
              blends with the rhythm of the waves. From sunrise to starlit
              skies, our gallery reflects the beauty and serenity of this
              seaside escape.
            </p>
        ...
        <section id="experiences" className="min-h-screen py-16 px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  ...
                  facing room. Very clean and comfortable with hot water, fan
                  and air conditioning. The staff are amazing, especially Snehal
                  who took the time to understand me, in fact all the staff were
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  ...
                  hospitality is really good. The positive aura you feel when
                  you enter this place. The hotel rooms are well maintained, the
                  food is authentic and the best beach view. Strongly
                  recommended if you are planning to stay in Malvan.&rdquo;
                </p>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  &ldquo;Chivla Paradise provided a wonderful weekend escape.
                  The beachfront location is stunning, and the owners&apos;
                  warmth truly stood out. Their flexibility and accommodative
                  nature made my stay incredibly comfortable, and the personal
                  attention was exceptional. Plus, the home-cooked meals were
                  delectable.&rdquo;
                </p>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  ...
                  also not crowded. And the best part was that it was just
                  across the road. The rooms were clean. Food was also tasty.
                  Overall it was a wonderful experience and i would definitely
                  recommend this paradise. 😊&rdquo;
                </p>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="font-medium">Holiday · Family</span>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  ...
                  environment. The beachfront view is absolutely stunning and
                  the staff is very friendly and helpful. The food is delicious
                  and authentic Malvani cuisine. Highly recommended for a
                  relaxing getaway.&rdquo;
                </p>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
